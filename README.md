...
## 7. pivot_root — Changing the Root Mount

### 7.1 Why Use pivot_root?
...
### 11.4 Prepare the Rootfs for pivot_root
...
| **rootfs + pivot_root** | Define the filesystem environment |
